  ...
  return (
    <div className="relative h-[350px] w-full md:h-[400px]">
      ...
      <div className="absolute top-0 flex w-full flex-col items-center justify-center px-12 py-20 max-lg:order-last">
        <div className="flex w-fit items-center gap-1 rounded-full border-2 bg-white px-3 py-1 text-xs font-semibold text-black shadow-md sm:text-sm">
          <Building size={16} />
          Top Quality Tech Brands
        </div>
        <div className="mt-3 flex w-full flex-col items-center justify-center">
          <h1 className="max-w-[350px] text-center text-xl font-extrabold leading-none text-white sm:text-2xl lg:max-w-[500px] lg:text-3xl">
          ...
          <p className="mt-2 w-full max-w-[350px] text-center text-xs text-slate-300 md:text-sm lg:max-w-[400px] lg:text-base">
